<template>
  ...
  <div
    v-else
    class="invitation-page"
    :class="'theme-' + (invitation.theme || 'elegant')"
  >
    <!-- COVER -->
      ...
      <div class="inv-cover-bg">
        ...
        <div
          ...
          style="
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, #2c2417, #4a3a28);
          "
        ></div>
      </div>
    ...
    <!-- COUNTDOWN -->
    <section
      v-if="invitation.akad_date || invitation.resepsi_date"
      class="inv-section fade-in"
      ref="countdownRef"
    ...
    <section
      ...
      class="inv-section inv-events fade-in"
      ref="eventsRef"
    >
    ...
    <!-- LOVE STORY -->
    <section
      v-if="loveStory.length > 0"
      class="inv-section inv-story fade-in"
      ref="storyRef"
    >
      ...
      <div class="story-timeline">
        <div
          v-for="(story, index) in loveStory"
          :key="index"
          class="story-item"
        >
    ...
    <section
      ...
      class="inv-section inv-gallery fade-in"
      ref="galleryRef"
    >
        ...
        <div class="form-group">
          ...
          <div class="radio-group">
            <div
              :class="[
                'radio-option',
                { active: rsvpForm.attendance === 'hadir' },
              ]"
            ...
            <div
              :class="[
                'radio-option',
                { active: rsvpForm.attendance === 'tidak_hadir' },
              ]"
      ...
      <div v-if="rsvpMessages.length > 0" class="rsvp-messages">
        ...
        <div v-for="msg in rsvpMessages" :key="msg.id" class="rsvp-message">
          ...
          <div class="msg-status">
            ...
            {{
              msg.attendance === "hadir" && msg.guest_count > 1
                ? `(${msg.guest_count} orang)`
                : ""
            }}
          </div>
        </div>
    ...
    >
      ...
      >
        ...
        <div style="font-size: 14px; color: var(--inv-text-light)">
          a.n. {{ invitation.bank_holder }}
        </div>
        <button
          style="
            margin-top: 12px;
