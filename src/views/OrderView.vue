  ...
  <div class="order-page">
    ...
    <main class="order-main">
      ...
      <div v-if="submitted" class="order-card order-success-card">
        ...
        <p>
          Kami sudah menerima pesanan Anda. Silakan lanjutkan pembicaraan di
          WhatsApp untuk konfirmasi pembayaran dan detail lebih lanjut.
        </p>
        <div class="order-success-summary">
          <div class="order-summary-row">
            <span class="order-summary-label">Mempelai</span>
            <span class="order-summary-value"
              >{{ form.groomName }} & {{ form.brideName }}</span
            >
          </div>
          <div class="order-summary-row">
        ...
        <div class="order-header">
          <div class="order-header-icon">
            <Icon
              ...
              class="order-header-icon-svg"
            />
          </div>
          <h1>Jasa Dibuatkan Undangan</h1>
          <p class="order-header-sub">
            Isi data di bawah ini, lalu kami yang akan membuatkan undangan
            digital premium untuk Anda. Terima jadi, tanpa ribet!
          </p>
        ...
        <form @submit.prevent="handleSubmit" class="order-form">
          ...
          <div class="order-section">
            ...
            <div class="order-field">
              <label for="customerPhone"
                >Nomor WhatsApp <span class="required">*</span></label
              >
              ...
              <span class="order-field-hint"
                >Kami akan menghubungi Anda via nomor ini</span
              >
            </div>
          </div>
          ...
          <div class="order-section">
            ...
            <div class="order-field-row">
              <div class="order-field">
                <label for="groomName"
                  >Nama Mempelai Pria <span class="required">*</span></label
                >
                <input
                  id="groomName"
              ...
              <div class="order-field">
                <label for="brideName"
                  >Nama Mempelai Wanita <span class="required">*</span></label
                >
                <input
                  id="brideName"
            ...
            <div class="order-field-row">
              ...
              <div class="order-field">
                <label for="theme"
                  >Pilihan Tema <span class="required">*</span></label
                >
                <select id="theme" v-model="form.theme" required>
                  <option value="" disabled>Pilih tema undangan</option>
                  <option v-for="t in themeOptions" :key="t.id" :value="t.id">
                    {{ t.name }}
                  </option>
                </select>
              </div>
            ...
            <div class="order-field">
              ...
              <textarea
                ...
                v-model="form.notes"
                rows="3"
                placeholder="Request khusus, informasi tambahan, dsb."
                maxlength="500"
              ></textarea>
            </div>
          </div>
          ...
          <div class="order-submit-section">
            <button
              type="submit"
              class="order-btn order-btn-submit"
              :disabled="submitting"
            >
              <Icon
                v-if="!submitting"
            ...
            <p class="order-submit-note">
              <Icon
                ...
                style="font-size: 14px; vertical-align: -2px; color: #94a3b8"
              />
              Data Anda aman. Anda akan diarahkan ke WhatsApp untuk konfirmasi
              pesanan.
            </p>
          </div>
        </form>
