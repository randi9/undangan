    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 32px; align-items: stretch;">
      <div v-for="(bank, index) in bankList" :key="index" style="flex: 1; min-width: 300px; max-width: 400px; display: flex; flex-direction: column; align-items: center; gap: 24px;">
        <div style="width: 100%; aspect-ratio: 1.58; padding: 24px; position: relative; display: flex; flex-direction: column; justify-content: space-between; text-align: left; z-index: 10; background: rgba(255, 255, 255, 0.4); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255, 255, 255, 0.6); box-shadow: 0 8px 32px rgba(0, 0, 0, 0.05); border-radius: 20px; overflow: hidden;">
          ...
          <img src="https://media.mengundanganda.com/floral-blue/rsv%20section/randidewi_de652656-b50b-496c-990f-6f89f16b39c8.webp" style="position: absolute; bottom: -15px; left: 80px; width: 110px; height: auto; opacity: 0.3; z-index: 0; pointer-events: none; transform: rotate(10deg);" alt="Gift Card Floral 2" />
          <img src="https://media.mengundanganda.com/floral-blue/rsv%20section/randidewi_de652656-b50b-496c-990f-6f89f16b39c8.webp" style="position: absolute; bottom: -10px; left: 140px; width: 80px; height: auto; opacity: 0.3; z-index: 0; pointer-events: none; transform: rotate(20deg);" alt="Gift Card Floral 3" />
