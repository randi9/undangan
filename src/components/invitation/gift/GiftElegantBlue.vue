  ...
  <section v-if="bankList.length > 0" class="py-24 px-6 text-center bg-[var(--theme-surface)]">
    ...
    <div class="flex flex-col items-center gap-12 w-full">
      ...
      >
        ...
        <div class="w-full aspect-[1.58] bg-gradient-to-br from-white/95 to-[#f8f9fa]/90 p-6 rounded-2xl shadow-xl border border-white/60 relative overflow-hidden flex flex-col justify-between text-left backdrop-blur-md">
