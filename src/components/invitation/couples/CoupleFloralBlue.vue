<template>
  <section id="couple-section-fb" ref="sectionRef" style="position: relative; z-index: 20; width: 100%; min-height: 100dvh; display: flex; flex-direction: column; justify-content: center; overflow: hidden; background-color: #f0f0f0;">
