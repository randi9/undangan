<template>
  <section ref="heroSection" class="relative min-h-[100dvh] flex flex-col items-center justify-center text-center px-4 overflow-hidden bg-[#f8f9f9]">
    <!-- Background wrapper set to 200dvh to spill over seamlessly into the Quote Section -->
      ...
      <svg class="absolute inset-0 w-full h-full opacity-100">
        <defs>
          <pattern id="elegant-damask-pattern" x="0" y="0" width="180" height="180" patternUnits="userSpaceOnUse">
            <!-- Center image -->
            <image href="https://media.mengundanganda.com/elegant_blue/hero%20section/randidewi_e4ba72c6-b2e4-4d02-aa58-d18e1ccebd39.webp" x="35" y="35" width="110" height="110" />
            <!-- Corner images (all facing upwards) -->
            <image href="https://media.mengundanganda.com/elegant_blue/hero%20section/randidewi_e4ba72c6-b2e4-4d02-aa58-d18e1ccebd39.webp" x="-55" y="-55" width="110" height="110" />
            <image href="https://media.mengundanganda.com/elegant_blue/hero%20section/randidewi_e4ba72c6-b2e4-4d02-aa58-d18e1ccebd39.webp" x="125" y="-55" width="110" height="110" />
            <image href="https://media.mengundanganda.com/elegant_blue/hero%20section/randidewi_e4ba72c6-b2e4-4d02-aa58-d18e1ccebd39.webp" x="-55" y="125" width="110" height="110" />
            <image href="https://media.mengundanganda.com/elegant_blue/hero%20section/randidewi_e4ba72c6-b2e4-4d02-aa58-d18e1ccebd39.webp" x="125" y="125" width="110" height="110" />
          </pattern>
        </defs>
    ...
    <div class="hero-oval absolute top-6 bottom-6 left-6 right-6 md:top-8 md:bottom-8 md:left-8 md:right-8 z-[14] pointer-events-none rounded-[1000px] opacity-0" style="box-shadow: 0 0 0 200vmax #f8f9f9; will-change: transform, opacity"></div>
