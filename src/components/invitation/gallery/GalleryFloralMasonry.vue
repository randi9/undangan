<template>
  <section v-if="photos && photos.length > 0" style="position: relative; width: 100%; padding: 64px 24px 120px; text-align: center; background-color: var(--theme-surface); overflow: hidden;">
    ...
    <div style="position: absolute; right: 5px; top: 10px; width: 50px; height: 50px; perspective: 600px; z-index: 2; transform: rotate(-5deg); pointer-events: none; opacity: 0.8;">
      <img src="https://media.mengundanganda.fun/tema%20floral/gallery%20section/enneggg_372e190a-9d64-430d-8750-d40ee495605d.webp" class="bw-left" style="animation-duration: 0.22s; animation-delay: -0.1s; position: absolute; left: 50%; top: 0; width: auto; height: 100%; transform-origin: left center; object-fit: contain;" />
      <img src="https://media.mengundanganda.fun/tema%20floral/gallery%20section/enneggg_372e190a-9d64-430d-8750-d40ee495605d.webp" class="bw-right" style="animation-duration: 0.22s; animation-delay: -0.1s; position: absolute; left: 50%; top: 0; width: auto; height: 100%; transform-origin: left center; object-fit: contain;" />
    </div>
    ...
    <div style="position: absolute; left: -10px; top: 40px; width: 60px; height: 60px; perspective: 600px; z-index: 2; transform: rotate(18deg); pointer-events: none; opacity: 0.8;">
      <img src="https://media.mengundanganda.fun/tema%20floral/gallery%20section/enneggg_372e190a-9d64-430d-8750-d40ee495605d.webp" class="bw-left" style="animation-duration: 0.38s; animation-delay: -0.3s; position: absolute; left: 50%; top: 0; width: auto; height: 100%; transform-origin: left center; object-fit: contain;" />
      <img src="https://media.mengundanganda.fun/tema%20floral/gallery%20section/enneggg_372e190a-9d64-430d-8750-d40ee495605d.webp" class="bw-right" style="animation-duration: 0.38s; animation-delay: -0.3s; position: absolute; left: 50%; top: 0; width: auto; height: 100%; transform-origin: left center; object-fit: contain;" />
    </div>
