<template>
  <section v-if="photos && photos.length > 0" ref="gallerySection" class="pt-24 pb-32 px-0 max-w-5xl mx-auto text-center relative overflow-hidden bg-[#F8F3EE]">
    ...
    <div ref="scrollRef" class="w-full flex overflow-x-auto snap-x snap-mandatory hide-scroll gap-4 px-6 md:px-12 pb-8 pt-4 items-center">
      <div 
        ...
        class="snap-center flex-shrink-0 w-[65vw] md:w-[350px] aspect-[3/4] md:aspect-[4/5] rounded-[2rem] overflow-hidden cursor-pointer group shadow-[0_15px_40px_rgba(106,78,66,0.06)] border border-[#EBCFD1] bg-white transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(106,78,66,0.12)] focus:outline-none"
      >
