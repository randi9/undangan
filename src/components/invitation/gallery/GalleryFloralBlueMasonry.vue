<template>
  <section v-if="photos && photos.length > 0" style="position: relative; width: 100%; padding: 64px 24px 120px; text-align: center; background-color: var(--theme-surface); overflow: hidden; z-index: 20;">
    ...
    <div style="position: absolute; right: 5px; top: 10px; width: 50px; height: 50px; perspective: 600px; z-index: 2; transform: rotate(-5deg); pointer-events: none; opacity: 0.8;">
      <img src="https://media.mengundanganda.com/tema%20floral/gallery%20section/sashkeh_6ed3fbd6-b062-4196-bb32-8b2b7206e6bb.webp" class="bw-left" style="animation-duration: 0.22s; position: absolute; left: 50%; top: 0; width: auto; height: 100%; transform-origin: left center; object-fit: contain; filter: hue-rotate(180deg) saturate(0.5);" />
      <img src="https://media.mengundanganda.com/tema%20floral/gallery%20section/sashkeh_6ed3fbd6-b062-4196-bb32-8b2b7206e6bb.webp" class="bw-right" style="animation-duration: 0.22s; position: absolute; left: 50%; top: 0; width: auto; height: 100%; transform-origin: left center; object-fit: contain; filter: hue-rotate(180deg) saturate(0.5);" />
    </div>
    ...
    <div style="position: absolute; left: -10px; top: 40px; width: 60px; height: 60px; perspective: 600px; z-index: 2; transform: rotate(18deg); pointer-events: none; opacity: 0.8;">
      <img src="https://media.mengundanganda.com/tema%20floral/gallery%20section/sashkeh_6ed3fbd6-b062-4196-bb32-8b2b7206e6bb.webp" class="bw-left" style="animation-duration: 0.38s; position: absolute; left: 50%; top: 0; width: auto; height: 100%; transform-origin: left center; object-fit: contain; filter: hue-rotate(180deg) saturate(0.5);" />
      <img src="https://media.mengundanganda.com/tema%20floral/gallery%20section/sashkeh_6ed3fbd6-b062-4196-bb32-8b2b7206e6bb.webp" class="bw-right" style="animation-duration: 0.38s; position: absolute; left: 50%; top: 0; width: auto; height: 100%; transform-origin: left center; object-fit: contain; filter: hue-rotate(180deg) saturate(0.5);" />
    </div>
    ...
    <div style="position: relative; z-index: 10; max-width: 64rem; margin: 0 auto;">
      <GalleryMasonryLayout :photos="photos" :api-base="apiBase" @open-lightbox="(i: number) => $emit('openLightbox', i)" />
    </div>
  </section>
</template>
...
defineProps<{ photos: Photo[]; themeConfig: ThemeConfig; apiBase: string; }>();
