...
app.get("/api/guests/:invitationId", requireAuth, async (req: any, res: any) => {
  try {
    const { data, error } = await supabase
      .from("guests").select("*")
      .eq("invitation_id", req.params.invitationId)
...
app.post("/api/guests/:invitationId/bulk", requireAuth, async (req: any, res: any) => {
  try {
...
app.put("/api/guests/:invitationId/:guestId", requireAuth, async (req: any, res: any) => {
  try {
...
app.delete("/api/guests/:invitationId/:guestId", requireAuth, async (req: any, res: any) => {
  try {
    const { error } = await supabase
      .from("guests")
      .delete()
